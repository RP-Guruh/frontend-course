...
<section
  class="relative bg-cover h-screen text-white bg-opacity-50"
...
>
  ...
  >
    ...
    <NavUl {hidden}>
      ...
      >
        <div class="font-semibold text-customWhite dark:text-white group-hover:text-black">
          {item.name}
        </div>
        <span class="text-sm font-light text-customWhite dark:text-gray-400 group-hover:text-black">
          {item.help}
        </span>
      </a>
  ...
  <img
    src={ufo}
    class="absolute top-12 lg:top-6 right-0 w-24 h-24 sm:w-32 sm:h-32 md:w-48 md:h-48 lg:w-40 lg:h-40 object-cover"
    alt="ufo"
  />
  <div class="mainSky"></div>
  <img
  id="rocket"
  src={rocket}
  alt="rocket"
  class="absolute top-72 lg:top-80 transform left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 lg:w-64 lg:h-64 object-cover {isLaunching
    ? 'rocket-movement'
    : ''}"
/>
